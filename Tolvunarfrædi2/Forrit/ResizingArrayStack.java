...
public class ResizingArrayStack<Item> implements Iterable<Item> {
    ...
    public static void main(String[] args) {
        ResizingArrayStack<String> stack = new ResizingArrayStack<String>(); // Or Stack<String> for Stack.java
        while (!StdIn.isEmpty()) {
        ...
        try {
            for (int i = 0; i <= stack.size(); i++) {
                StdOut.println(stack.peek(i));
            }
        } catch (NoSuchElementException e) {
            StdOut.println("NoSuchElementException caught");
        }
    }
}
